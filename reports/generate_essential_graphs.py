...
def print_results_interpretation():
    ...
    print(\"over basic Minimax search. At depth 3, Alpha-Beta achieves a 2.2× speedup,\")
    print(f\"reducing computation time from {data['minimax_time'][0]:.3f}s to {data['alphabeta_time'][0]:.3f}s.\")
    print(f\"This advantage grows exponentially with search depth, reaching {data['speedup'][-1]:.1f}× speedup\")
